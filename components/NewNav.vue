  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
      ...
      <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
        <NuxtLink href="/login"
           class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Zaloguj</NuxtLink>
<!--        <a href="#"-->
        ...
        <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
          <li>
            <NuxtLink href="/"
               ...
               aria-current="page">Strona Główna</NuxtLink>
          </li>
          <li>
              ...
              <div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                <NuxtLink href="/formy-zajec"
                      ...
                      Stanowiska
                                ...
                                <NuxtLink href="/jednostki-organizacyjne"
                       class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">
